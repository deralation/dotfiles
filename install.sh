...
if [[ ! `uname` =~ "darwin" ]]; then
  ...
  git config --global core.editor "'/Applications/Visual Studio Code.app/Contents/SharedSupport/bin/subl' -n -w"
  bundler_editor="'/Applications/Visual Studio Code.app/Contents/SharedSupport/bin/subl'"
